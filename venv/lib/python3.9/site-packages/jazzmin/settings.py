...
DEFAULT_SETTINGS: Dict[str, Any] = {
    ...
    "site_logo": "vendor/adminlte/img/rpml02.png",
    # Welcome text on the login screen
    "welcome_sign": "",
    # Copyright on the footer
    "copyright": "Todos los derechos reservados #DivInf",
    ...
    "icons": {"auth": "fas fa-users-cog", "auth.user": "fas fa-user", "auth.Group": "fas fa-users", "core.Informacion":"fas fa-info-circle", "core.Area":"fas fa-dice-one", "core.Area":"fas fa-map-marker-alt", "core.PlanDeContingencia":"fas fa-clipboard-check text-yellow"},
